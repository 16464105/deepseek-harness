...
Source: [`packages/browser/browser/src/index.ts:30`](../packages/browser/browser/src/index.ts)
...
Source: [`packages/llm/llm-tencent-codebuddy/src/index.ts:47`](../packages/llm/llm-tencent-codebuddy/src/index.ts)
...
Source: [`packages/mcp/mcp-manager/src/index.ts:31`](../packages/mcp/mcp-manager/src/index.ts)
...
- `@deepseek-ai/dsh-browser-popup` — 需要 `browser`（[`packages/browser/browser-popup/src/index.ts`](../packages/browser/browser-popup/src/index.ts)）
