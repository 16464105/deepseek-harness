...
/**
 * The built-in prefix every Desktop profile starts with. The desktop
 * application layer carries this fork's deployment facts — the Tencent route,
 * the browser suite, the MCP manager and its Settings page, and the raised
 * image bound — so a profile without it boots the plain Web surface.
 */
