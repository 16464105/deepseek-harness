...
export interface ModelCatalogModel {
  ...
  description?: string
  /** Input modalities accepted by this exact model; absence means the adapter did not declare them. */
...
export interface SessionModels {
   ...
   */
  routable: boolean
  /** Whether visible history or the pending inbox requires the next model to accept image input. */
