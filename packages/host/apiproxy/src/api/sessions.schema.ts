...
/** Merge-extensible model modality value: non-empty on the wire, typed after validation. */
const modelModalitySchema = z.string().min(1) as unknown as z.ZodType<ModelModality>
