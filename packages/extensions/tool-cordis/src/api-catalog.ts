...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: '@Remote(\'open\') async open(signal: AbortSignal): Promise<{ opened: boolean; path: string }>',
        description: 'Open the managed `mcp.json` in a native text editor (client-side action).',
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: '@Remote(\'openDirectory\') async openDirectory(signal: AbortSignal): Promise<{ opened: boolean; path: string }>',
        description: 'Open the user skills directory on the host desktop.',
        parameters: [{ name: 'signal', description: 'caller lifetime carried by the Remote transport.' }],
        returns: 'whether the native opener accepted the path; the client reveals the directory as text when it did not.',
...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  {
    name: 'SkillDirectoryInfo',
    declaration: 'export interface SkillDirectoryInfo {\n    readonly openDirectory: string;\n    readonly canOpenPath: boolean;\n}',
  },
  {
    name: 'SkillEntry',
  ...
  {
    name: 'SkillListValue',
    declaration: 'export interface SkillListValue extends SkillDirectoryInfo {\n    readonly skills: readonly SkillEntry[];\n}',
  },
  {
