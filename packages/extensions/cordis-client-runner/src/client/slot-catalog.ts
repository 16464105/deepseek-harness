...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      'browser-popup BrowserPopupAction',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-models ProviderOnboardingDialog id \'provider-credential\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-skill SkillSettingsSection id \'skills\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'browser-popup () => { const [visible, setVisible] = useState(isPopupVis…',
    ],
    replaceRisk: 'none',
