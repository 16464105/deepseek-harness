...
export const en = {
  ...
  tencentKeyHint: 'Go to https://tencent.sso.codebuddy.cn/profile/keys to generate a CodeBuddy key.',
  ...
  onboardingTencentTitle: 'Connect to Tencent internal models',
  onboardingTencentDescription: 'Enter your CodeBuddy key to use the Tencent internal model.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  tencentKeyHint: '请前往 https://tencent.sso.codebuddy.cn/profile/keys 生成 CodeBuddy Key。',
  customized: '自定义设置',
  baseUrl: 'API 地址',
  ...
  onboardingTencentTitle: '连接腾讯内网模型',
  onboardingTencentDescription: '填入 CodeBuddy Key，即可使用腾讯内网模型。',
