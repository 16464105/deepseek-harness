/** `settings.skill` namespace dictionaries for the Skills settings section. */
...
export type SkillSettingsKey = keyof typeof zh
...
} satisfies Record<SkillSettingsKey, string>

/** Namespace this section registers its dictionaries under. */
