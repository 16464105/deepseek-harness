---
description: "MCP settings section for the Web client: manages local-process and Streamable HTTP servers."
...
The section reads and writes through the `mcp-manager` Remote; all writes apply immediately and are persisted by the host.
