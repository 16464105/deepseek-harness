...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-mcp': { kind: 'none', reason: 'Browser-side MCP settings layer; registers nothing model-facing.' },
  ...
  'packages/mcp/mcp-manager': { kind: 'indirect', reason: 'The manager delegates discovered model-visible tools to its mounted mcp-client fibers.' },
